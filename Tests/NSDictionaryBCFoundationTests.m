...
- (void)testCategories {
  ...
  for (NSDictionary *d in @[testDictionary, [testDictionary mutableCopy]]) {
    ...
    ECTestAssertNil([d arrayForKey_BC:@"dictionary"]);
    ...
    ECTestAssertNil([d dictionaryForKey_BC:@"array"]);
    ...
    ECTestAssertNil([d numberForKey_BC:@"array"]);
    ...
    ECTestAssertFalse([d boolForKey_BC:@"array"]);
